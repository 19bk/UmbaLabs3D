...
spk_d   = 45;            // speaker opening (42mm measured + 3mm clearance)
...
usbc_pw = 9.0;           // USB-C plug width (8.4mm + 0.6mm clearance)
usbc_ph = 3.2;           // USB-C plug height (2.6mm + 0.6mm clearance)
...
led_x  = bw - cr - 2;   // bottom-right corner of front face
...
module lid() {
    difference() {
        union() {
            ...
            // Washer ring removed — was floating (not connected to walls/ceiling)
            // Hot-glue the steel washer inside instead
        }
